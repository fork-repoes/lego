...
public class SmartFaultExecutor {
    ...
    private MethodInvocationRecoverer<?> findRecoverHandler(Object target) {
        ...
        return new RecoverAnnotationRecoveryHandler<Object>(target, this.methodBySmartFault);
    }
    ...
    private Object fallback(MethodInvocation joinPoint) throws Throwable{
        ...
        if (recoverHandler != null){
            return fallbackTemplate.execute(retryInvoker, (RecoveryCallback<Object>) context -> {
    ...
    private class RetryInvoker implements RetryCallback<Object, Throwable> {
