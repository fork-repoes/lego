...
public class TagBasedDispatcherConsumerContainer
    ...
    private String findTag() {
        ...
        return this.tagMethods.keySet().stream()
        ...
        public ConsumeOrderlyStatus consumeMessage(List<MessageExt> msgs, ConsumeOrderlyContext context) {
            for (MessageExt messageExt : msgs) {
                ...
                try {
                    ...
                    log.warn("consume message failed. messageId:{}, topic:{}, reconsume Times:{}", messageExt.getMsgId(), messageExt.getTopic(), messageExt.getReconsumeTimes(), e);
